...
genome_file_path = CODE_ROOT_PATH / 'accessory_files/GRCh38.genome_file.tsv'
...
if __name__ == '__main__':
    ...
    for interval_offset in CHUNK_POSITION_OFFSETS:
        ...
        std_intervals = get_stdchrom_intervals(genome_file=genome_file_path, interval_size=CHUNK_SIZE,
