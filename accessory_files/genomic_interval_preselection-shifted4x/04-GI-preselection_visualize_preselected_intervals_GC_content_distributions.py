...
reference_fgcd = SOURCE_CODE_PATH / 'accessory_files/hg38_reference_GC_content_distribution.tsv'
...
output_directory = SOURCE_CODE_PATH / ('accessory_files/genomic_interval_preselection-shifted4x/'
                                       'FGCD_intervals_vs_reference')
