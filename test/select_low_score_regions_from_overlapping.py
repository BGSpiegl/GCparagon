...
if SOURCE_CODE_ROOT_DIR not in sys.path:
    print("| INFO - adding GCparagon software parent directory to Python search path "
          f"variable: {SOURCE_CODE_ROOT_DIR}")
    sys.path.append(SOURCE_CODE_ROOT_DIR)
