...
griffin_matrices_path = MY_ABSOLUTE_SOURCE_DIRECTORY_PATH / 'validation/01_transformed_Griffin_bias_matrices'
gcparagon_matrices_parent_path = MY_ABSOLUTE_SOURCE_DIRECTORY_PATH / ('validation/01_transformed_Griffin_bias_matrices/'
                                                                      'GCparagon_matrices_per_preset')
...
if __name__ == '__main__':
    for correction_algo in correction_algos:
        ...
        if correction_algo == 'GCparagon':
            for preset in range(1, 3, 1):  # no preset 3 yet
                ...
                # summarize
                print(f"\n -> The average discrepancy for '{correction_algo}-preset{preset}' correction was: "
            ...
            # summarize
            print(f"\n -> The average discrepancy for '{correction_algo}' correction across all samples was: "
                  f"{np.mean(across_samples):.3%}\n")
...
# sample 'B01': discrepancy pool sizes post GCparagon-preset1 weighting vs. original size: 0.524%
# sample 'C01': discrepancy pool sizes post GCparagon-preset1 weighting vs. original size: 0.241%
# sample 'H01': discrepancy pool sizes post GCparagon-preset1 weighting vs. original size: 0.990%
# sample 'P01': discrepancy pool sizes post GCparagon-preset1 weighting vs. original size: 1.211%
#
#  -> The average discrepancy for 'GCparagon-preset1' correction was: 0.742%
#
# Processing now results for preset2 ..
# sample 'B01': discrepancy pool sizes post GCparagon-preset2 weighting vs. original size: -0.121%
# sample 'C01': discrepancy pool sizes post GCparagon-preset2 weighting vs. original size: -0.039%
# sample 'H01': discrepancy pool sizes post GCparagon-preset2 weighting vs. original size: -0.020%
# sample 'P01': discrepancy pool sizes post GCparagon-preset2 weighting vs. original size: 0.090%
#
#  -> The average discrepancy for 'GCparagon-preset2' correction was: -0.022%
#
#
