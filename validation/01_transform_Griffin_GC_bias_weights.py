...
gc_bias_files_parent_path = MY_ABSOLUTE_SOURCE_DIRECTORY_PATH / 'validation/Griffin_bias_matrices'
...
transformed_matrices_output_path = MY_ABSOLUTE_SOURCE_DIRECTORY_PATH / 'validation/transformed_Griffin_bias_matrices'
