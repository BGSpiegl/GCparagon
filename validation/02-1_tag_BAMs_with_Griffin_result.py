...
SOURCE_CODE_ROOT_PATH = SCRIPT_PARENT_PATH.parent
...
# order of samples in tuples below is important! must correspond between bam_path, weight_paths, and masks_paths !!!
input_path = SOURCE_CODE_ROOT_PATH / 'preset_computation'
# TODO: you must DOWNLOAD these sample BAM files from EGA DB first !!! (see README.md)
bam_path = (input_path / 'B01.bam',
            input_path / 'H01.bam',
            input_path / 'C01.bam',
            input_path / 'P01.bam')
weights_path = SOURCE_CODE_ROOT_PATH / 'validation/01_transformed_Griffin_bias_matrices'
