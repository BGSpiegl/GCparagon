...
output_dir = SCRIPT_ROOT_PATH / '03_genome-wide_correction_fidelity/FGCD_correction_plots'
IMAGE_FORMATS = ('png', 'svg', 'pdf')

# TODO: DEFINE THE CORRECT NAMES BELOW! (e.g. timestamp)
all_samples_dists_files = {'preset1': SCRIPT_ROOT_PATH /
                                      '03_genome-wide_correction_fidelity/'
                                      'GCPARAGON-STATISTICS_allSamples_GC-percentage_perFragmentSequence_17-10-2023_'
                                      'preset1.tsv',
                           'preset2': SCRIPT_ROOT_PATH /
                                      '03_genome-wide_correction_fidelity/'
                                      'GCPARAGON-STATISTICS_allSamples_GC-percentage_perFragmentSequence_17-10-2023_'
                                      'preset2.tsv'}

reference_gc_path = SCRIPT_ROOT_PATH / '03_genome-wide_correction_fidelity/simulated_hg38_ref_gc'
...
def main():
    for preset_string, all_samples_dists_path in all_samples_dists_files.items():
        print(f"INFO - computing {preset_string} ..")
        ...
        original_gc_distributions_all_samples, corrected_gc_distributions_all_samples_algorithms = read_stats(
            stats_path=all_samples_dists_path, return_as_percentage=True)
        ...
        for sample, ref_dist_path_sample in reference_gc_dists_samples.items():
            ...
            for plot_markers in (False, ):  # (True, False):
                ...
                for algo in corrected_gc_distributions_all_samples_algorithms.keys():  # add corrected lines for all algorithms
                ...
                plot_fragment_gc_dists_griffin(
                    ...
                    out_dir_path=output_dir / preset_string,
