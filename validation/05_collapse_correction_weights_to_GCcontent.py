...
parent_paths = {'Griffin': MY_ABSOLUTE_SOURCE_DIRECTORY_PATH /
                'validation/transformed_Griffin_bias_matrices',
                'GCparagon': MY_ABSOLUTE_SOURCE_DIRECTORY_PATH /
                'GCparagon_matrices_compared_against/preset{}'}
...
GRIFFIN_OBSERVATION_MATRICES_PATH = MY_ABSOLUTE_SOURCE_DIRECTORY_PATH / \
                                    "Griffin_correction_validation/transformed_Griffin_bias_matrices"
GCPARAGON_OBSERVATION_MATRICES_PATH_STR = str(MY_ABSOLUTE_SOURCE_DIRECTORY_PATH /
                                              'GCparagon_matrices_compared_against/preset{}')

# use theoretical optimum flength dists (original from Griffin, preset 3 for GCparagon)
...
# for GCparagon: preset 3 observations used for theoretical distribution computation
...
output_path = MY_ABSOLUTE_SOURCE_DIRECTORY_PATH / 'Griffin_correction_validation/GCcontent_accumulated_weights'
output_path.mkdir(parents=True, exist_ok=True)

combine_percentages = 2  # like in plots
    ...
    for correction_algo, weight_matrix_dict in correction_weights_matrices.items():
        ...
        for sample_id, weight_matrix_path in correction_weights_matrices[correction_algo].items():
            ...
            observed_matrix, observations_flength_range = load_txt_to_matrix_with_meta(
                filename=observed_fragments[correction_algo_complete][sample_id], to_dtype=int)
            ...
            print(f"{correction_algo} - {sample_id}: average weight across all GC content percentages: "
                  f"{np.mean(average_weight_gc_content):.2f}")
...
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# Griffin - C01: average weight across all GC content percentages: 2.10
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
...
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset1 - B01: average weight across all GC content percentages: 1.38
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset1 - C01: average weight across all GC content percentages: 1.18
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset1 - H01: average weight across all GC content percentages: 1.10
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset1 - P01: average weight across all GC content percentages: 1.27
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset2 - B01: average weight across all GC content percentages: 1.45
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset2 - C01: average weight across all GC content percentages: 1.20
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset2 - H01: average weight across all GC content percentages: 1.10
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset2 - P01: average weight across all GC content percentages: 1.26
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset3 - B01: average weight across all GC content percentages: 1.52
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset3 - C01: average weight across all GC content percentages: 1.22
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset3 - H01: average weight across all GC content percentages: 1.11
# the sum of all relative fragment length occurrences was: 1.0000 (1.0 expected)
# GCparagon-preset3 - P01: average weight across all GC content percentages: 1.30
