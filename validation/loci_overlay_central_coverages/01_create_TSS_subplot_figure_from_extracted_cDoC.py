...
tss_coverage_csv_paths = {'GCparagon': CONTENT_ROOT_DIR / 'validation/loci_overlay_central_coverages/GCparagon',
                          'Griffin': CONTENT_ROOT_DIR / 'validation/loci_overlay_central_coverages/Griffin',
                          'Original': CONTENT_ROOT_DIR / 'validation/loci_overlay_central_coverages/notCorrected'}

output_file_path = CONTENT_ROOT_DIR / \
                   'validation/loci_overlay_central_coverages/plot_output/DoC_bias_correction_effect_TSSs.png'
...
def main() -> int:
    ...
    cov_data = {}
    for corr_algo, npz_parent_dir in tss_coverage_csv_paths.items():   # iter over correction state
        ...
        for npz_candidate in npz_candidates:   # iter over samples
            ...
            cov_data[sample_name][region_class][signal_type] = c80_filtered_average_covs
    ...
    fig.update_annotations(font={'family': 'Ubuntu',
                                 'size': FIGURE_FONT_SIZE,
                                 'color': 'rgb(20, 20, 20)'})  # format subplot titles
