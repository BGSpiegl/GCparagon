...
tfbs_coverage_csv_paths = {'GCparagon': CONTENT_ROOT_DIR / 'validation/loci_overlay_central_coverages/GCparagon',
...
output_file_path = CONTENT_ROOT_DIR / \
                   'validation/loci_overlay_central_coverages/plot_output/DoC_bias_correction_effect_TFBSs.png'
...
def main() -> int:
    ...
    # ------------------------------------------------------------------------------------------------------------------
    cov_data = {}
    for corr_algo, npz_parent_dir in tfbs_coverage_csv_paths.items():
